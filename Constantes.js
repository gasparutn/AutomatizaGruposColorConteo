...
// --- (NUEVO) Constantes para la Hoja Contador ---
/**
 * Nombre de la hoja que muestra el resumen de grupos.
 */
const NOMBRE_HOJA_CONTADOR = "Contador";

/**
 * Columna (A) donde se escribirá el nombre del grupo en la hoja Contador.
 * @type {number}
 */
const COL_GRUPOS_CONTADOR_NOMBRE = 1;

/**
 * Columna (B) donde se escribirá el total en la hoja Contador.
 * @type {number}
 */
const COL_GRUPOS_CONTADOR_TOTAL = 2;
